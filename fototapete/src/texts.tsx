const textData = {
    ...
    hrv: {
        mainBillboard: {
            title: 'Preobrazite svoj interijer s našim prilagođenim fototapetama!',
            handwriteTop: 'Vi zamislite',
            handwriteBottom: 'mi to činimo!',
            article: 'Tražite nešto posebno za svoj dom ili posao? Nudimo fototapete izrađene po mjeri, izrađene prema dimenzijama vaših zidova, osiguravajući savršeno uklapanje u vaš prostor.',
        },
        bestsellers: {
        ...
        transforming: {
            ...
            articleTitle1: 'Prilagođene veličine',
            articleText1: 'Svaka od naših tapeta izrađena je prema vašim zidnim mjerama, što jamči savršeno pristajanje',
            articleTitle2: 'Individualni pristup',
            articleText2: `Ako ste pronašli sliku koja vam se sviđa, ali nije u našem katalogu — pošaljite nam je, a mi ćemo vam pomoći pronaći sličnu opciju ili stvoriti nešto slično`,
            articleTitle3: 'Širok raspon dizajna',
            articleText3: 'Nudimo najveći izbor stilova na tržištu, pomažući vam stvoriti jedinstvenu atmosferu u vašem interijeru',
            articleTitle4: 'Usluga montaže',
            articleText4: 'Brza i kvalitetna montaža od strane naših stručnjaka',
            articleTitle5: 'Brza dostava',
            articleText5: 'Dobijte svoju pozadinu za samo 3-5 radnih dana!',
        },
        calculate: {
            title: 'Možete izračunati trošak vašeg budućeg projekta',
        ...
        howToPlace: {
            ...
            step1Text: 'Pozadinu možete odabrati iz naše galerije ili sa web stranice www.shutterstock.com upisivanjem ključnih riječi u polje za pretraživanje (koju god fotografiju nađete pošaljite nam je, a mi ćemo je dizajnirati kao pozadinu). Također nam možete poslati bilo koju fotografiju (vašu ili preuzetu s interneta), a mi ćemo provjeriti je li prikladna za tisak.',
            step2Title: 'Unesite dimenzije',
            step2Text: 'Izmjerite širinu i visinu površine na koju želite staviti tapetu i unesite dimenzije u cm. Predlažemo da prije mjerenja pročitate sve važne napomene i pogledate vodič za montažu. Naš tim rado će uzeti mjere za vas (ova usluga se naplaćuje).',
            ...
            step5Title: 'Montaža',
            step5Text: 'Možete angažirati naše montere ili tapete postaviti sami prema uputama koje smo pripremili za vas.',
        },
        wallpapersInInteriors: {
        ...
        orderingProcess: {
            ...
            point1: 'Usluga mjerenja',
            point2: 'Individualni razvoj dizajna',
            point3: 'Ispis uzoraka',
        ...
        commonQuestions: {
            ...
            quesions: [{
                ...
                answer: 'Da, želimo! Javite nam se sa svojom idejom, a mi ćemo pronaći dodatne galerije za vas. Pozadinu možete odabrati iz naše galerije ili sa web stranice www.shutterstock.com upisivanjem ključnih riječi u polje za pretraživanje (koju god fotografiju nađete pošaljite nam je, a mi ju izradimo kao pozadinu). Također nam možete poslati bilo koju fotografiju (vašu ili preuzetu s interneta), a mi ćemo provjeriti je li prikladna za tisak.',
            }, {
                question: 'Koliko cm još treba dodati postojećim mjerama zida?',
                answer: 'Da, želimo! Javite nam se sa svojom idejom, a mi ćemo pronaći dodatne galerije za vas. Pozadinu možete odabrati iz naše galerije ili sa web stranice www.shutterstock.com upisivanjem ključnih riječi u polje za pretraživanje (koju god fotografiju nađete pošaljite nam je, a mi ju izradimo kao pozadinu). Također nam možete poslati bilo koju fotografiju (vašu ili preuzetu s interneta), a mi ćemo provjeriti je li prikladna za tisak.',
            }, {
                question: 'Jesu li moguće određene izmjene na uzorku koji odaberem?',
                answer: 'Da, želimo! Javite nam se sa svojom idejom, a mi ćemo pronaći dodatne galerije za vas. Pozadinu možete odabrati iz naše galerije ili sa web stranice www.shutterstock.com upisivanjem ključnih riječi u polje za pretraživanje (koju god fotografiju nađete pošaljite nam je, a mi ju izradimo kao pozadinu). Također nam možete poslati bilo koju fotografiju (vašu ili preuzetu s interneta), a mi ćemo provjeriti je li prikladna za tisak.',
            }, {
                question: 'Koliko je potrebno da tapeta stigne nakon što naručimo?',
                answer:'Da, želimo! Javite nam se sa svojom idejom, a mi ćemo pronaći dodatne galerije za vas. Pozadinu možete odabrati iz naše galerije ili sa web stranice www.shutterstock.com upisivanjem ključnih riječi u polje za pretraživanje (koju god fotografiju nađete pošaljite nam je, a mi ju izradimo kao pozadinu). Također nam možete poslati bilo koju fotografiju (vašu ili preuzetu s interneta), a mi ćemo provjeriti je li prikladna za tisak.',
            }, {
                question: 'Kakav je postupak u slučaju prigovora?',
                answer: 'Da, želimo! Javite nam se sa svojom idejom, a mi ćemo pronaći dodatne galerije za vas. Pozadinu možete odabrati iz naše galerije ili sa web stranice www.shutterstock.com upisivanjem ključnih riječi u polje za pretraživanje (koju god fotografiju nađete pošaljite nam je, a mi ju izradimo kao pozadinu). Također nam možete poslati bilo koju fotografiju (vašu ili preuzetu s interneta), a mi ćemo provjeriti je li prikladna za tisak.',
            }],
        },
        subscribe: {
        ...
        helpfulArticles: {
            ...
            handwrite: 'Naš blog',
            articles: [
                {text: `5 savjeta za uređenje dječje sobe`, img: '/fototapete/article-1.png', link: ''}, 
                {text: 'Povoljni trikovi za uređenje doma', img: '/fototapete/article-2.png', link: ''}, 
                {text: 'Kako odabrati savršenu pozadinu?', img: '/fototapete/article-3.png', link: ''},
            ]
        },
        footer: {
            titleTop: `Ostanimo u`,
        ...
        btns: {
            ...
            goToCategory: 'Idi na kategoriju',
